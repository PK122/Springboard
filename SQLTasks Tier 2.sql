...
/*CONCAT was not working for me so I tired doing (c.FirstName+','+c.LastName) and also  (column1 || ' '|| column2) but it did not work.
Below is what I would have done if CONCAT workd */
